import { HStack, useToast, VStack, Alert, Text, IconButton, CloseIcon, Center, Button } from "native-base"
import React from "react"

const ToastAlert: React.FC = () => {
    const toast = useToast()

    const TAlert = ({ id, status, variant, title, description, isClosable, ...rest }) => (
        <Alert
            maxWidth="100%"
            alignSelf="center"
            flexDirection="row"
