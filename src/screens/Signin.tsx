  ...
  useEffect(() => {
    const concac = async () => {
      if (Platform.OS === "android")
        return ScreenOrientation.lockAsync(ScreenOrientation.OrientationLock.LANDSCAPE_RIGHT);
    };
    concac();
  }, []);
  ...
  return (
    <View>
      ...
      <TouchableOpacity style={{ position: "absolute", top: 30, left: "32%" }}>
        <Image alt="No image" source={require("../../assets/LoginTitle.png")} style={{ width: 280, height: 60 }} />
      </TouchableOpacity>
      <View
        style={{
          position: "absolute",
      ...
      >
          ...
          <Controller
            ...
            render={({ field: { onChange, onBlur, value } }) => (
              <View style={{ position: "relative" }}>
                ...
                >
                  <Image alt="No image" source={require("../../assets/Button.png")} style={{ width: 36, height: 32 }} />
                </TouchableOpacity>
              </View>
            )}
            name="password"
        ...
        >
          <TouchableOpacity style={{ bottom: 9, right: 10 }} onPress={handleGoogleLogin}>
            <Image alt="No image" source={require("../../assets/Google.png")} style={{ width: 36, height: 36 }} />
          </TouchableOpacity>
          <TouchableOpacity style={{ bottom: 9, right: 10 }} onPress={handleFacebookLogin}>
            <Image alt="No image" source={require("../../assets/Facebook.png")} style={{ width: 36, height: 36 }} />
          </TouchableOpacity>
          <TouchableOpacity style={{ bottom: 9, right: 10 }}>
            <Image alt="No image" source={require("../../assets/Apple.png")} style={{ width: 36, height: 36 }} />
          </TouchableOpacity>
        </View>
      ...
      >
        <AntDesign name="arrowleft" size={30} color="white" style={{ position: "absolute", top: "5%", left: "4%" }} />
      </TouchableOpacity>
    </View>
  );
};
